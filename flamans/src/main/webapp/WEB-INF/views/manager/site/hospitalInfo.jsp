...
function showResult(){
	if(XHR.readyState==4){
		if(XHR.status==200){
			...
			var msg='<table id="list_table"><tr><th id="list_th1"> 병원 이름 </th><th id="list_th2"> 사업자 번호 </th><th id="list_th3"> E-Mail </th><th id="list_th4"> 전화 번호 </th><th id="list_th5"> 관리</th></tr>';
			
			if(hospitalList.length==0){
				msg+='<tr><td colspan="5"> 검색된 병원이 없습니다 </td></tr></table>';	
			}else{
...
<%@ include file="/WEB-INF/views/myIndex.jsp"%>
	<div id="page-wrapper">
		<h2>병원 관리 하기</h2>
		<h3>
			<input type="button" value="승인된 병원" onclick="show(1);" class="btn btn-default">
			<input type="button" value="신청한 병원" onclick="show(2);" class="btn btn-default">
		</h3>
		<br><br>
		<div id="table"></div>
	</div>
