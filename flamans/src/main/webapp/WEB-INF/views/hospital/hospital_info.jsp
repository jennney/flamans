...
<body>
	...
	<div align="center">
		...
		<div style="width: 1000px;">
			...
			<div
				style="border: 5px solid teal; width: 270px; float: left; white-space: nowrap; margin: 0px center;">
				<%@ include file="hospital_sub_search.jsp"%>
			</div>

			<div
				style="border: 5px solid teal; width: 700px; float: right; margin-left: 0px auto;">
				...
				<c:forEach var="hospital_info" items="${hospital_info }">
					...
					<table border="0" width="700" class="table table-hover">
						...
						<tr>
							<td width="600" style="padding-top: 30px;"><h1>【
					...
					<table border="0" width="700" class="table table-hover">
						<tr>
							...
							<td width="550" valign="top" rowspan="2">■병원 상세정보 입력란■
								${hospital_info.hos_content }</td>
						</tr>
