...
<link rel="stylesheet" href="asset/bootstrap/css/bootstrap.min.css"
	type="text/css">
<link rel="stylesheet"
	href="asset/font-awesome/css/font-awesome.min.css" type="text/css">
			...
			if (XHR.status == 200) {
				...
				if ('${not empty sessionScope.userid}' == 'true') {
					...
					for ( var i in data.hos) {
						data_hos += '<a href="hospital_get_info.do?hos_num='
								+ data.hos[i].hos_num
								+ '">'
								+ '<img src="img/'+data.hos[i].hos_img+'" width=50 height=50>&nbsp;&nbsp;'
								+ data.hos[i].hos_name + '</a><br>';
					}

					for ( var i in data.hot) {
						data_hot += '<a href="hotel_get_info.do?hot_num='
								+ data.hot[i].hot_num
								+ '">'
								+ '<img src="img/'+data.hot[i].hot_img+'" width=50 height=50>&nbsp;&nbsp;'
								+ data.hot[i].hot_name + '</a><br>';
					}

					var wishlist = '<h6 align="center">〔 위시 리스트 〕</h6><hr> <h6 align="center">[ 병원 리스트 ]</h6> '
							+ data_hos
							+ ' <hr> <h6 align="center">[ 호텔 리스트 ]</h6>'
							+ data_hot;

				} else {
					var wishlist = data;

					var header_wishlist = document
							.getElementById('header_wishlist');
						...
						<div class="col-md-6">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"><i class="fa fa-heart"
										onmouseover="wishlist()"></i> <b class="caret"></b></a>
	...
	<div class="navbar navbar-default navbar-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.do">Flamens</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="#">Event</a>
						<ul class="dropdown">
							<li><a href="event_user_list1.do?e_item=1">On going
									Event</a></li>
							<li><a href="event_user_list2.do?e_item=2">Finished
									Event</a></li>
						</ul></li>
