...
<body>
	<div class="seaTabs">
		<div class="seaTabs_switch">
			<div class="seaTabs_tab seaTabs_switch_active"><a href="#" onclick="location.href='faq_List.do'">전체</a></div>
			<div class="seaTabs_tab"><a href="#" onclick="location.href='faq_List.do?faq_item=hospital'">병원</a></div>
